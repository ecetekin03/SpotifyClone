    ...
    public class MusicPlayerService : IMusicPlayerService
    {
        ...
        public void Play(int mediaId)
        {
            ...
            if (_currentMedia != null)
            {
                ...
                try
                {
                    // 🔧 Göreli yolu tam (absolute) yola çevir
                    string fullPath = Path.GetFullPath(_currentMedia.FilePath ?? "");

                    if (!File.Exists(fullPath))
                    {
                        MessageBox.Show($"Şarkı dosyası bulunamadı:\n{fullPath}", "Hata", MessageBoxButton.OK, MessageBoxImage.Error);
                        return;
                    }
                ...
                {
                    MessageBox.Show("Şarkı oynatılırken hata oluştu:\n" + ex.Message, "Hata", MessageBoxButton.OK, MessageBoxImage.Error);
                    Stop();
                }
            }
        }
